...
public class WebConfig implements WebMvcConfigurer {
    ...
    private String cityResultImagePath;

    @Value("${web.file-path}")
    private String cityResultFilePath;

    @Value("${web.wyhcimg-path}")
    private String wyhcImagePath;
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        registry.addResourceHandler("/accessFile/**").addResourceLocations("file:"+cityResultImagePath).addResourceLocations("file:"+cityResultFilePath).addResourceLocations("file:"+wyhcImagePath);
//        registry.addResourceHandler("/accessFile/**").addResourceLocations("file:"+cityResultFilePath);
    }
